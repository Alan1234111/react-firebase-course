...
function App() {
  ...
  const uploadFile = async () => {
    ...
    const filesFolderRef = ref(storage, `projectsFiles/${fileUpload.name}`);
    try {
  ...
  return (
    <div className="App">
      ...
      <div>
        ...
        <input placeholder="Release title..." type="number" onChange={(e) => setNewReleasedDate(Number(e.target.value))} />
